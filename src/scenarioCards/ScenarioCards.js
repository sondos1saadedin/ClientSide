...
class ScenarioCards extends React.Component {
    constructor(props) {
        super(props);
    ...
    componentDidMount() {
        fetch('http://localhost:8090/get-scenarios?email=' + this.props.email)
...
export default connect(mapStateToProps)(ScenarioCards);