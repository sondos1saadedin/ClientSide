  ...
  createClass(FilteringState, [{
    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        React.createElement(dxReactCore.Getter, { name: 'filterExpression', computed: dxGridCore.pushFilterExpression(filters) }),
  ...
  createClass(IntegratedFiltering, [{
    ...
    value: function render() {
      ...
      var rowsComputed = function rowsComputed(_ref) {
        ...
        return dxGridCore.filteredRows(rows, filterExpression, getCellValue, getColumnPredicate, isGroupRow, getRowLevelKey);
      };
  ...
  createClass(SearchState, [{
    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        React.createElement(dxReactCore.Getter, { name: 'filterExpression', computed: dxGridCore.pushSearchFilterExpression(value) }),
