...
var ResizingControlLine = function ResizingControlLine(_ref) {
  ...
  var resizingControlLineBody = resizing && createElement('div', {
    ...
    value: function render() {
      ...
      return createElement(
        ...
        createElement(
          ...
          createElement(ResizingControlLine, { resizing: resizing, style: { left: '5px' } }),
          createElement(ResizingControlLine, { resizing: resizing, style: { left: '7px' } })
        )
      );
    }
  }]);
...
var SortingControl = function SortingControl(_ref) {
  ...
  return align === 'right' ? createElement(
    'span',
    props,
    createElement(SortingIndicator, {
      direction: sortingDirection
